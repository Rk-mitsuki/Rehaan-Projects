Here, the code is very scattered. The core algorithm is in the ReducedOrderModel-Numerical file and is saved as a .pkl file. This is then taken to the predict.py file to develop the web app. 
